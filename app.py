...
async def home(request: Request):
    ...
    reservas_ativas = [r for r in reservas if r['data_saida'] >= date.today()]
...
async def pagina_add_reserva(request: Request):
    ...
    return templates.TemplateResponse(
        ...
        context={"hospedes": hospedes, "quartos": quartos}
    )
...
async def pagina_edit_reserva(request: Request, id: int):
    ...
    return templates.TemplateResponse(
        request=request,
        name="form_reserva.html",
        context={"reserva": reserva, "hospedes": hospedes, "quartos": quartos}
    )
